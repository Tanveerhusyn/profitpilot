...
import featureImg from "../assets/feature03.jpg";

function FeatureThree() {
  return (
    <div className="w-[100%] mt-10  flex justify-center items-center">
      <Container>
        <Row className="mx-10 flex flex-col md:flex-row-reverse gap-4">
          ...
          <div className="flex justify-end items-center w-[100%] md:w-[45%] mx-2">
